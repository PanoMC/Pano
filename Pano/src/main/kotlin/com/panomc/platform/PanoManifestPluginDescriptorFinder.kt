...
class PanoManifestPluginDescriptorFinder : ManifestPluginDescriptorFinder() {
    companion object {
        ...
        private const val PLUGIN_PANO_VERSION: String = "pano-version"
    ...
    override fun createPluginDescriptor(manifest: Manifest): PluginDescriptor {
        ...
        val panoVersion = attributes.getValue(PLUGIN_PANO_VERSION)
        ...
        pluginDescriptor.panoVersion = panoVersion
