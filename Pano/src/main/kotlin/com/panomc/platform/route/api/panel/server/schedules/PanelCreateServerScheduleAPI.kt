...
/** Creates one schedule on a server. */
@Endpoint
class PanelCreateServerScheduleAPI(
    ...
    override val paths = listOf(Path("/api/panel/servers/:id/schedules", RouteType.POST))
    ...
    override suspend fun handle(context: RoutingContext): Result {
        ...
        val schedule = scheduleService.create(server, definition, userId, sqlClient)
        ...
        databaseManager.panelActivityLogDao.add(
            ServerScheduleActionLog(
                ...
                username,
                id,
                ServerScheduleActionLog.ACTION_CREATE,
                schedule.name,
                schedule.cron
            ),
            sqlClient
